	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{.6\linewidth}
				...
				\includegraphics[width=1\linewidth]{figures/Screen Shot 2017-01-30 at 9.45.52 AM.png}
			\end{column}
	...
	\begin{frame}
		...
		\begin{columns}
			\begin{column}{.6\linewidth}
				...
				\includegraphics[width=1\linewidth]{figures/Screen Shot 2017-01-30 at 9.49.13 AM.png}
			\end{column}
			\begin{column}{.4\linewidth}
				%\centering
				\begin{itemize}
