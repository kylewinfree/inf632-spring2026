...
\begin{description}
	...
	\item [Course Website:] \url{canvas.nau.edu}, \url{https://github.com/kylewinfree/inf632-spring2026}
\end{description}
%\vspace{2em}

% Professor information
\begin{tabular}{ l l }
	\multirow{6}{*}{\includegraphics[width=1in]{kyle.eps}} & Kyle N. Winfree \\
	& kyle.winfree@nau.edu \\
	& winfreelab.nau.edu \\
	& SICCS (90) Room 204 \\
	& Office Hours: TBD and to minimize conflicts with your class schedule \\
